const input = ['5-6 s: zssmssbsms', '3-6 j: jjjjjrrj', '4-7 k: kfkgkkkkk', '2-3 n: nkbgfnn', '7-12 h: hhhhhhdhhhhhfhhhh',
    '1-4 v: nvvv', '6-9 h: hhthplhgmpzsmhhxhh', '6-7 r: rrtrrrgrgcc', '10-15 h: sdbhvbhfjhwllmrpdv', '3-4 s: bsss', '5-7 s: sstjsswsspldr',
    '10-14 b: bzbqbbbkpvbblbnrbs', '4-11 s: sssmcskwsssssss', '2-10 v: rlttvvnvvvvvvksm', '4-5 x: xkrxx', '2-5 m: bfmmmmm',
    '11-14 r: rlprrtrcrxcrgrrhrr', '4-16 l: dzllmllldnllblwcr', '3-4 t: nplr', '3-5 x: jcxxgkxtjwwgh', '3-4 j: msjcjqjgxmjsjfjjj',
    '1-6 z: zgkkdzww', '3-5 q: pgqqbq', '17-19 t: tttkttwtttttttttttt', '5-11 n: nqnlfknntdn', '11-12 c: ccccccccccgc',
    '2-14 x: pxmvfrrwlbzxhk', '4-5 g: gcggwggxv', '4-5 h: phbzhhhqhl', '4-5 h: hwbhk', '1-2 t: tgmq', '16-19 l: llllbjlfvnlhwlllqfp',
    '4-6 r: srrrqggrs', '1-3 g: nggwhvcl', '1-8 f: pffffffff', '2-3 l: lllll', '13-15 d: ddrdkdddmdmdddd', '11-13 r: rrrgrkrrdrwrrr',
    '3-10 x: xxxxxxxtxq', '6-7 p: pspzpvlpxnplhtpc', '3-8 f: fsfkfbffvxfc', '3-5 z: zzzvwzsfktz', '4-7 c: cccgccc', '11-12 n: nnnnnnnnnnzn',
    '12-13 n: nnnnnnnmznnpnnn', '4-7 q: wqqzgqgfg', '5-13 p: tgplpbpmvgpppktps', '12-13 x: zwcxlnhwpsvxm', '7-10 r: rrrrrrnrrrrgr', '1-5 r: rlrrj',
    '15-18 l: nlllllslcllllllllcl', '10-11 w: wnwwzwwwwwwwmwrwr', '10-11 j: njmmjjjcjjv', '3-6 z: vgbdvzgzzzzw', '7-8 r: bbcvxzrqpqskcmhwsvx',
    '4-5 c: rgvcgmccc', '6-9 d: ddddddddd', '6-7 g: gggsggg', '4-7 c: ffclfbcdmcvnshw', '3-5 n: xnznv', '6-7 d: ddddddk', '1-2 r: rjvprt',
    '6-7 p: ppphppp', '1-11 p: ppppppppppxppp', '10-16 x: bxxnxpxxxcxjxtxnw', '4-8 s: hzsvsswc', '10-12 p: lpwswppppvppphp', '2-3 d: bdcddnxc',
    '4-6 s: ssscssp', '18-19 k: kkkkkkkjkkkkkkkkkzk', '4-6 x: ncxpxx', '6-8 h: xhhhqxrhhhfh', '15-16 p: qppjnpzfvppzdppgppp', '1-7 d: dwvdddddc',
    '3-4 w: wlshzvqw', '4-16 s: sbwgjshsznhdsssjts', '4-8 t: ptttbkbhtt', '11-12 w: wwddwwwwwwwj', '2-6 z: zkzzzzzhzzzz', '3-6 b: bbxbbb', '3-6 z: zztzzq',
    '2-3 h: hhjhh', '1-5 x: xptxl', '10-11 n: nnwnnnnnndrnpp', '5-6 s: jsswmjzkrspsms', '2-7 n: nnnnnnnn', '4-6 q: qqqhgxg', '5-6 r: rrrrqrr', '4-5 k: kstjksjbkhhfpzkl',
    '5-6 n: nnnnqpldn', '11-13 w: mptdwqgfkwwzb', '3-4 x: ccxxmxfzfztxvxdg', '2-13 w: wwwwwgjwwwwwwwwwwww', '1-5 m: mrmkjqhdcqbz', '7-8 l: lldllllh',
    '7-17 d: ddvddddktmckjbmds', '3-8 n: htnnnnqlv', '3-8 v: chvkvjkvxl', '8-12 t: rtffbltcbtttwtqbvt', '1-8 n: nhnbvdwq', '6-11 b: bblbbmbbbbbbbbbbb',
    '4-7 s: rssbphs', '8-9 q: wqqdqqqwqq', '10-11 f: sfwfffdffhntffj', '4-5 x: xlxbxx', '2-4 d: lvdd', '3-6 t: djtcsmjrrt', '7-11 v: lvvvvvxvvvv',
    '3-4 c: ccpc', '3-17 g: nzgjkrpwbfcgzqjvtth', '8-15 l: lnhlllgllvgllbgscl', '10-11 z: zzzzmzzzzmzzjz', '3-10 b: bwntlkjnfbm', '5-6 f: vffxnfjffp',
    '1-4 s: dvcssdw', '11-13 c: cccctcfccckct', '4-6 m: cmtzbmkqqgbmpsmbxwkw', '11-13 j: jhjjcjmjjjqjvj', '6-7 q: qqqqqqqq', '4-10 f: fmxffftfnbm',
    '7-10 n: cdnrfrnvpmmhpnmxbnx', '8-9 z: zzzzzzzvz', '2-9 h: zrvhddntmhjhhh', '11-12 g: gggggggggggg', '1-2 h: vhtgfg', '1-2 g: gggp',
    '1-2 r: nrktwt', '2-8 b: bslkbbbbb', '1-5 q: lrfqmq', '10-14 q: qbqbqpqqqrqdqqq', '7-16 r: nvrrzhsgrwthgbrqkqh', '4-5 z: zzzzh',
    '3-8 v: nkvwfvlvv', '8-9 z: zzzzzzzfs', '2-4 w: vrlrss', '1-2 j: jnqswjgps', '7-8 f: ffzffffwff', '11-12 k: klwqntvkpcthq',
    '5-13 k: kkkkkkkkkkkklk', '2-5 w: wwwdxgwwszb', '1-13 q: cqqqqtqqdmmnqm', '3-8 q: bqtlqqzn', '3-12 n: xnzdxdnndpnnqhcnnnnn', '6-7 r: kqhrrrxldrmwr', '3-5 k: hjkdp',
    '5-6 h: hhhqhrmhbh',
...
function part1() {
    console.log(input.reduce((agg, i) => {
        const min = +i.split('-')[0];
        const max = +i.split('-')[1].split(' ')[0];
        const letter = i.split(' ')[1][0];
        const word = i.split(': ')[1];
        const occur = Array.from(word).reduce((l, c) => l + (c === letter), 0);
        return agg + (min <= occur && occur <= max);
    }, 0));
}

function part2() {
    console.log(input.reduce((agg, i) => {
        const p1 = +i.split('-')[0] - 1;
        const p2 = +i.split('-')[1].split(' ')[0] - 1;
        const letter = i.split(' ')[1][0];
        const word = i.split(': ')[1];
        return agg + ((word[p1] === letter && word[p2] !== letter) || (word[p2] === letter && word[p1] !== letter));
    }, 0));
}
